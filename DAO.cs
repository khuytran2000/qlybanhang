...
namespace Quản_lý_bán_hàng
{
    class DAO
    {
        ...
        public static string ConnnectionString = "Data Source=DESKTOP-KLPOHE4\\SQLEXPRESS;Initial Catalog=QLbanhang;Integrated Security=True";
        ...
        {
            SqlDataAdapter MyData = new SqlDataAdapter(sql, conn); //Định nghĩa đối tượng thuộc lớp SqlDataAdapter
